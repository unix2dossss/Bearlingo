        ...
        {projects.map((p, i) => (
          <div key={i} className="rounded-2xl border border-gray-300 p-6">
            ...
            <label className="block text-sm font-semibold mb-1">
              Project Outcome / Key features (2 sentences)
            </label>
            <textarea
            ...
            <label className="block text-sm font-semibold mb-1">Role + Contribution (2–3 sentences)</label>
            <textarea
              className="w-full min-h-[90px] rounded bg-gray-100 px-3 py-2 mb-4 focus:outline-none focus:ring-2 focus:ring-[#4f9cf9]"
            ...
            <label className="block text-sm font-semibold mb-1">Link (GitHub/Demo) — optional</label>
            <input
