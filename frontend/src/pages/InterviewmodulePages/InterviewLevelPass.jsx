...
import main from "../../assets/Interview Module Passed.svg";
import { useNavigate } from "react-router-dom";
import { useUserStore } from "../../store/user";

const InterviewLevelPass = ({ onClose }) => {
  ...
  const handleClick = () => {
    onClose(); // close popup
    navigate("/NetworkingModule"); // then go to next page
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div
        ...
        style={{
          background: "linear-gradient(270deg, #bcde14,  #14de1b, #4ec5ff, #befbbb)",
        ...
        <div className="bg-white rounded-lg p-8 shadow-xl">
          ...
          <div className="bg-[#befbbb] rounded-lg p-4 mb-6">
            <p className="text-[#0aad3b] italic">
              You’ve nailed your interview prep! Your confidence is shining bright.
            </p>
          </div>
...
export default InterviewLevelPass;
