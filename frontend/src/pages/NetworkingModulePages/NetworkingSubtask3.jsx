...
export default function NetworkingSubtask3({ userInfo = {}, onBack }) {
  ...
  const filteredReflections = useMemo(() => {
    ...
    console.log("Filtered Reflections", list);
    return list;
  ...
  const saveReflection = async () => {
    try {
      ...
      console.log("eventSelected", eventSelected.eventId);
  ...
  return (
    <div className="min-h-screen w-full bg-[#fffef6]">
      {/* Back button */}
      <button className="btn btn-ghost absolute top-20 left-6 z-50 text-[#111827]" onClick={onBack}>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-1 text-xs text-slate-500">
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[11px] font-semibold text-[#7a6a28]">
                              {" "}
                              {score.toFixed(1)}
                            </span>
                          </div>
                                  ...
                                  <span
                                    className={`text-[11px] sm:text-xs text-center ${
                                      selected
                                        ...
                                        : "font-medium text-[#7a6a28] opacity-70"
                                    }`}
                                  >
                                    {captions[idx]}
                                  </span>
